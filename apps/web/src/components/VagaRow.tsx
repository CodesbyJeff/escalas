...
export function VagaRow({ escalaId, vaga, funcaoProps, conflito, onSetMilitar, onRemove, patentesEsperadas }: {
  ...
  return (
    <Group gap="xs" wrap="nowrap" bg={conflito ? 'red.1' : undefined} p={4}>
      ...
      <MilitarPicker escalaId={escalaId} value={vaga.militar_id} onChange={onSetMilitar} patentesEsperadas={patentesEsperadas} />
